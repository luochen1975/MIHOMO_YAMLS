...
- **路径**: `base-clash-ruleset.yaml` | **大小**: 13.7 KB | [查看源码](https://github.com/luochen1975/MIHOMO_YAMLS/blob/main/THEYAMLS/General_Config/Pililink/base-clash-ruleset.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: 🚫
<details>
